...
check(emc)
pp <- predict(emc, n_cores=40, conditional_on_data=FALSE, n_post = 50, return_trialwise_parameters=TRUE)
...
plot_spectrum(dat=dat, pp=pp, trial_duration=1.265)  # mean trial duration of this task was 1.265 s, which we use to determine the periods
```
